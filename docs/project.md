...
* Github Actions - [github.com/ndejong/elasticsearch_kibana_cli/actions/workflows/build-tests](https://github.com/ndejong/elasticsearch_kibana_cli/actions/workflows/build-tests.yml)
